...
RSE_CONFIG = GameMemoryConfig(
    ...
    platform="gba",
    generation=3,
    pokedex_caught_start="0x0202985C",  # RSE specific - caught flags
    pokedex_seen_start="0x02028A5C",    # RSE specific - seen flags
    max_pokemon=202,  # Hoenn dex only for RSE
...
FRLG_CONFIG = GameMemoryConfig(
    ...
    platform="gba",
    generation=3,
    pokedex_caught_start="0x02024E04",  # FRLG specific - caught flags (different from RSE!)
    pokedex_seen_start="0x02024004",    # FRLG specific - seen flags (different from RSE!)
    max_pokemon=151,  # Kanto dex only for FRLG
